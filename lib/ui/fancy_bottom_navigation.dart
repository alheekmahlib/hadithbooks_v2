...
import 'package:hadithbooks_v2/paint/half_clipper.dart';
import 'package:hadithbooks_v2/paint/half_painter.dart';
...
//    لون العنصر عند الضغط عليه
    activeIconColor = (widget.activeIconColor == null)
        ? (Theme.of(context).brightness == Brightness.dark)
            ? Colors.black54
            : Colors.lightGreen[800].withAlpha(450).withBlue(60)
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    color: state.themeData.canvasColor, boxShadow: [
                  BoxShadow(
                          ...
                          child: Stack(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                  ...
                                  width: ARC_WIDTH,
                                  child: CustomPaint(
                                    painter: HalfPainter(state.themeData.canvasColor),
                                  )),
                              SizedBox(
                                height: CIRCLE_SIZE,
                                width: CIRCLE_SIZE,
